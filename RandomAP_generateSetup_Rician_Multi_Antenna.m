function [R_AP,HMean_Withoutphase,channelGain] = RandomAP_generateSetup_Rician_Multi_Antenna(M,K,N,nbrOfSetups,correlatedShadowing)
...
%      %Go through all APs
     for m = 1:M
            ...
            %scattering model
            R_AP(:,:,m,k,n) = channelGain_NLoS(m,k,n)*functionRlocalscattering(N,angletoUE,ASDdeg,antennaSpacing);
